...
\newcommand*{\dogebreak}{
    \nottoggle{isFirstSectionInChapter} { \includegraphics[height=2em]{Dogebreak.png} } {} %
}
...
\titleformat{\section}
{}
{\filright \includegraphics[height=2em]{Dogebreak.png} \Large\bfseries \enspace Tip \#\arabic{tipsCounter}\enspace }
{8pt}
{\Large\bfseries}
