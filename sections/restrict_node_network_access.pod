...
Whether you run the Core daemon C<dogecoind> or the Qt GUI C<dogecoin-qt> (see
L<understand_core_programs>), if you allow RPC access, you give up some degree
of security and isolation in return for getting data from and potentially
changing data in your Core node. This is a tradeoff. It's often worth it, I<if>
you manage the security implications carefully.
