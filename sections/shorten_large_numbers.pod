...
What does ten look like? In base 16, that's C<A>. Eleven is C<B>. Twelve,
through and fifteen are C<C>, C<D>, C<E>, and C<F>. You already know what
sixteen is. Seventeen is C<11>. Twenty-six is C<1A> (read it as one times
sixteen plus ten). Beyond that, use a hexadecimal calculator; don't worry about
