...
fall back to generic English. Similarly, if there's a Portuguese in Portugal
...
=begin screen
  ...
  -resetguisettings
       Alle instellings wat in die grafiese gebruikerkoppelvlak
       gewysig is, terugstel
...
1.14.9, using the C<--help> command does not process your configuration file
