...
winning transaction from the list and reduce the modulus by one. Repeat this
process and continue until you've awarded everything. The same rules apply:
make the algorithm and all of its input data available to anyone who wants to
check your work.
