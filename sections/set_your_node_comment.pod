...
cause drama like "Patrick is a curmudgeon!N<He'll probably agree, so this is
the worst thing your author wanted to put in print.>", think twice. There are
human beings on the other side of the Internet, and our funny dog money only
works if we all work together and cooperate.
...
Dōgenzaka, Shibuya City", think twice, then three and four times. Personal
...
You could advertise your Doge-related project: "Check out IfDogeThenWow!"
