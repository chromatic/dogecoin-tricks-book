...
the Qt GUI as of 1.14.6). You'll see a list of other nodes you've connected to,
along with like their IP addresses (IPv4 or IPv6), the amount of data sent and
received, and more.
