...
Finance::Dogecoin::Utils> if you have Perl installed. Otherwise....>, as it
provides a command named C<dogeutils>, or you could do the work yourself.

What do you need?

=head3 *Associate Labels with Addresses

X<< RPC calls; C<setlabel> >>
...
X<< RPC calls; C<getreceivedbylabel> >>
