...
officially vetted by the Core developers, but the provenance of that image is
less worrisome. If, instead, someone tells you "Download this file, then run
your core wallet with this command-line option to use this image!" never do
what they say. Fun customizations entirely under your control are one thing.
