...
through the network and the more demand there is for the network's value. This
doesn't necessarily mean that the price will go up or stay the same or not go
down, but it does mean that there's more that you can do with your million
Dogecoin--and there are more ways you can receive Dogecoin. Holding for the
sake of holding may help you, but if everyone does that, it helps no one. Help
yourself and help other people instead. More people spending means more people
running nodes, running miners, buying and selling. That makes a stronger
network, more utility, and more reach.
