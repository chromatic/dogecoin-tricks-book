...
There are a few parameters that define how all of the world should interpret
blockchain data, such that it's easy to distinguish between a Bitcoin value, a
Litecoin value, a Dogecoin value, and any of the other myriad cryptocurrencies
built around the Bitcoin design. In the Dogecoin source code, these parameters
look like:
