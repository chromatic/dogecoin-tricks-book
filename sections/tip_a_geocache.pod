...
Back in the day, to get where you wanted to go, you either had to have someone
give you directions (people did this over the phone, and phones had cords
connected to the wall) or plan out your route with a paper map. This feels like
ages ago. Sure, a few hundred GPS satellites launched by the end of 1978, but
you had to be really into satellites and coordinates to use them.

Then hand-held receivers appeared and became popular. Then phones became
smaller and smarter and more capable, and now there's a chance you're reading
about Dogecoin on a device that can know exactly where in the world you are.
Now you can get directions from almost anywhere in a populated area to almost
anywhere else in a populated area (and many unpopulated areas too) with a few
taps on a phone.

New technology adoption happens that way. Things start slow, with gradual
adoption of something that seems weird or scary or complicated, and then things
go faster when cool and fun and useful applications arrive. That happened with
GPS and it could happen with Dogecoin as well.

=head2 *What is Geocaching?

One of the theses behind this book is "people learn by playing". Geocaching is
a kind of collective scavenger hunt where people hide containers ("caches") and
then post clues and coordinates to help others find them. Caches can be in busy
urban areas (like a park) or in the middle of nowhere (like a forest). They can
be small (an empty pill bottle or film canister) or large (a multi-liter
bucket).
...
Larger caches often contain a log book, where people can sign their names to
record that they deciphered the clues. Many of these larger caches also include
small trinkets, that people can take and replace--sort of a take one, leave one
approach. These trinkets can be stickers, tiny plastic toys, or even
low-denomination coins from far-off countries. This suggests an opportunity.
...
also repeat the fact that a wallet is just one way to keep track of private
...
A paper wallet is a piece of paper with some kind of data on it such as a
Dogecoin address, private key, and QR code representing that key; it's a way to
share that private key and address with someone else so they can claim the
unspent funds for that address. It can be an effective way to give someone
their first Dogecoin--such as tucking a piece of paper into a birthday card for
your niece on her thirteenth birthday and proving you're the coolest
aunt/uncle/relative ever.
...
Dogecoin, you'll need to transfer that amount to the address shown on the paper
...
a dollar, so (at current prices of about $0.07 USD per Dogecoin), 5 or 10
...
transaction security, immediately transferring the funds to a new and secure
