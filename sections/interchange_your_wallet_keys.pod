...
=head2 *The Wallet Import Format

The I<Wallet Import Format> or WIF encodes private keys in a shorter fashion
and includes a checksum to help detect errors. You'll often see wallet backups
and private key generators use this format. The Bitcoin wiki explains this
wellN<See U<https://en.bitcoin.it/wiki/Wallet_import_format>.>, but doesn't
