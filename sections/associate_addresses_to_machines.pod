...
L<program_real_buttons>), you might have machine names mapped to IP addresses
from your DHCP serverN<If this seems more technical than you want to manage
right now, trade a couple of pints of ice cream with an IT-savvy friend to set
this up!>. Follow a few steps to get up and running.
