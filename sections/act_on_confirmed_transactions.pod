...
That theory works well in practice. How can you take advantage of this
consensus? How can you determine your own confidence in any given block?
...
separate process for every new block. It doesn't keep anything in
memory--including the number of blocks to wait to consider the transaction
irreversible.
...
The second option is easier: store the data somewhere. Let's do something
simple; here's a RubyN<Why Ruby? You can use any language you like. Why I<not>
Ruby?> script that takes a block height and block hash as input, looks for
interesting transactions, and stores data in a simple YAMLN<Why YAML? Part of
it was designed in your author's living room. Only the good parts, of course.>
file:
...
file could be in the current directory or elsewhere, named whatever you like.
