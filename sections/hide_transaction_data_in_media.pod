...
If you can find a way to brand and transfer instances of media files between
people I<without> storing anything other than transaction data in the
blockchain, maybe you can find a better use case for NFTs than the world has so
far.
