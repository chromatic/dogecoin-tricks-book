...
play I<Donkey Kong Jr.> but worries that the person getting ice cream behind
him will corner him in the parking lot and demand 1000 Dogecoin from Patrick's
Big Whale Wallet, you've lost a good customer.
...
Skip over the "add a credit to the game" piece for now (see L<flip_a_switch>).

To make this work, you need a steady and unique supply of Dogecoin addresses
(see L<export_wallet_data>). You need a way to give a unique address to a
