...
Your F<dogecoin.conf> file can contain this information. You have to prepare it
with some information from a file in the Dogecoin repository called
...
When your node starts, you can now connect to it with your preferred RPC
mechanism. I like to use the C<curl> binary, because it has nothing to do with
Dogecoin or any other cryptocurrency, so if I can get it to work, I know I have
everything configured correctly.

=begin screen

$ B<curl --data-binary '{"jsonrpc":"1.0","id":"curltext","method":"getdifficulty","params":[]}' \>
    B<http://lisa:...@127.0.0.1:22555>
{"result":8101199.900972591,"error":null,"id":"curltext"}
...
The configuration file and the Core don't actually know your password. The
