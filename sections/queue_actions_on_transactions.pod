...
Assuming you have a database storing things like wallet addresses (see
L<rotate_machine_addresses>), you can create a new table to store basic
...
=begin screen
    ...
    CREATE INDEX transaction_output_to_wallet_idx
              ON transaction_output (to_wallet);
...
=begin screen
    ...
    CREATE TABLE action (
        ...
        expires_timestamp TIMESTAMP WITHOUT TIME ZONE NOT NULL
                          DEFAULT CURRENT_TIMESTAMP,
